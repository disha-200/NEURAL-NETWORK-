...
network.back_propogation(X_train, y_train, X_test, y_test, iterations=500, regularizer_lambda=0.05, alpha=0.25)
...
plt.xlabel('Number of Iteration * 142 training instances')
