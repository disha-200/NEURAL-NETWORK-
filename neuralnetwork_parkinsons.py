...
# print(target_column)
data_wo_target = data.drop(['target'],axis=1,inplace=False)
...
for i in range(k):
    ...
    network.back_propogation(X_train, y_train, iterations=1000, regularizer_lambda=0.25, alpha=1.25)
    # cost_output = network.cost_function(X_train, y_train, regularizer_lambda=0.00)
